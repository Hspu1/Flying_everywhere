...
Revision ID: ab5756b56322
Revises: 
Create Date: 2024-12-26 22:21:45.925224
...
def upgrade() -> None:
    ...
    op.create_table('aircraft',
            ...
            sa.Column('aircraft_name', sa.String(length=20), nullable=False),
            sa.Column('aircraft_weight', sa.Integer(), nullable=False),
            sa.Column('aircraft_length', sa.Integer(), nullable=False),
            sa.PrimaryKeyConstraint('aircraft_id')
    )
    op.create_index(op.f('ix_aircraft_aircraft_name'), 'aircraft', ['aircraft_name'], unique=False)
    ...
    op.create_table('flight',
            ...
            sa.Column('data_time', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_aircraft_aircraft_name'), table_name='aircraft')
